...
var myFuture = new Date(2025, 10, 18, 22, 15, 25);
console.log(myFuture);

console.log(myFuture.getDate() + "/" ,myFuture.getMonth()+1 + "/", myFuture.getFullYear(), ", ", myFuture.getDay());

var myFuture2 = new Date(2025, 10, 18, 22, 15, 25); //exactly same as myFuture.
console.log("Two bdays are equal: ", myFuture == myFuture2); // surprisingly they are not equals
console.log("Two bdays are equal: ", myFuture.getTime() == myFuture2.getTime()); // they are equals
